...
- [react@16.8.5](https://www.npmjs.com/package/react)
- [react-dom@16.8.5](https://www.npmjs.com/package/react-dom)
- [react-router-dom@5.0.0](https://www.npmjs.com/package/react-router-dom)
- [antd@3.16.1](https://www.npmjs.com/package/antd)
- [lodash@4.17.11](https://www.npmjs.com/package/lodash)
- [react-loadable@5.5.0](https://www.npmjs.com/package/react-loadable)
- [webpack@4.28.4](https://www.npmjs.com/package/parcel-bundler)
- [babel@7.3.4](https://www.npmjs.com/package/babel-core)
- [typescript@3.4.2](https://github.com/Microsoft/TypeScript)
